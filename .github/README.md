...
[`@aws-sdk/client-grafana`](https://www.npmjs.com/package/@aws-sdk/client-grafana/v/3.1047.0).
...
- @aws-sdk/client-grafana v3.1047.0 - [https://cloud-sdk-builds.github.io/?sdk=client-grafana&version=3.1047.0](https://cloud-sdk-builds.github.io/?sdk=client-grafana&version=3.1047.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-grafana@3.1047.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nEN+qEpLLTsCnAc+qHwSOGAMGCZI1wxzqRl72vuqh+puaBnAKAkLAIZX6pKVUG3j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-grafana": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-grafana@3.1047.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-grafana@3.1047.0/index.min.mjs": "sha384-nEN+qEpLLTsCnAc+qHwSOGAMGCZI1wxzqRl72vuqh+puaBnAKAkLAIZX6pKVUG3j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-grafana/blob/refs/tags/3.1047.0/LICENSE
```
